...
class GEETrajectories:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'GEETrajectories_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&GEETrajectories')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GEETrajectories', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/GEETrajectories/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'GEETrajectories'),
            callback=self.run,
