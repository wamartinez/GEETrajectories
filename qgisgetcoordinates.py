...
/***************************************************************************
 qgisgetcoordinates
                                 A QGIS plugin
 Get coordinates
 Generated by Plugin Builder: https://github.com/wamartinez/qgis-getcoordinates
                              -------------------
        begin                : 2021-06-24
        git sha              : $Format:%H$
...
from .time_series_ndvi import get_series_ndvi
import os.path

#Import libraries GEE
import ee
from ee_plugin import Map
import ogr
import matplotlib.pyplot as plt

class qgisgetcoordinates:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'qgisgetcoordinates_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&qgisgetcoordinates')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('qgisgetcoordinates', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/qgisgetcoordinates/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'qgisgetcoordinates'),
            callback=self.run,
    ...
    def update(self, point: QgsPointXY):
        ...
        serie = get_series_ndvi(userCrsPoint.x(),userCrsPoint.y())
        print("Done")
